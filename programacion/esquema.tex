\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación imperativa}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{1e}\ \ce{3c}\ \ce{3f}\ \ce{3g}\ \ce{5a}\ \ce{5b}\ \ce{5c}\ \ce{5d}\ \ce{5e}\ \ce{6c}\ \ce{6d}\ \ce{6e}\ \ce{6h}\ \ce{6i}\ \ev1\ \ra1\ \ra3\ \ra5\ \ra6\ (est: 2021\==10\==25)
    \begin{longenum}
        \item Modelo de ejecución
        \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Tipos de datos estructurados}} \ce{1d}\ \ce{1h}\ \ce{3f}\ \ce{3g}\ \ce{5b}\ \ce{6c}\ \ce{6d}\ \ce{6e}\ \ce{6g}\ \ev1\ \ra1\ \ra3\ \ra6\ (est: 2021\==11\==08)
    \begin{longenum}
        \item Conceptos básicos
        \begin{longenum}
            \item Introducción
