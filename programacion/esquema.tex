\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Tipos y operaciones}} \ev1\ (est: 2025\==10\==06)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación funcional}} \ev1\ (est: 2025\==10\==13)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
            \item Concepto
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación procedimental}} \ce{6g}\ \ev1\ \ra6\ (est: 2025\==11\==24)
    \begin{longenum}
        \item Conceptos básicos
        \begin{longenum}
            \item Procedimientos
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Secuencias}} \ce{6a}\ \ce{6b}\ \ce{6c}\ \ce{6d}\ \ev2\ \ra6\ (est: 2026\==01\==14)
    \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Relaciones entre clases}} \ce{7a}\ \ce{7b}\ \ce{7c}\ \ce{7d}\ \ce{7e}\ \ce{7f}\ \ce{7g}\ \ce{7h}\ \ce{7i}\ \ce{7j}\ \ev2\ \ra7\ (est: 2026\==02\==25)
    \begin{longenum}
