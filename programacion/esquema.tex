\begin{longenum}
    ...
    \begin{longenum}
        ...
        \begin{longenum}
            ...
            \end{longenum}
            \item Identificadores libres de una expresión lambda
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Calidad}} \ev1\ (est: 2025\==12\==01)
    \begin{longenum}
        \item Documentación interna
        \begin{longenum}
            \item Concepto
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Colecciones e iteradores}} \ev2\ (est: 2026\==01\==07)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
            \item Composición
