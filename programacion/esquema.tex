\begin{longenum}
    \item \textbf{\textsc{Introducción}} \ev1\ \ra1\ (est: 2019\==09\==16)
    \begin{longenum}
    ...
    \begin{longenum}
        ...
        \begin{longenum}
            ...
            \begin{longenum}
                ...
                \item Orden normal
            \end{longenum}
            \item Variables libres y ligadas
    ...
    \end{longenum}
    \item \textbf{\textsc{Tipos de datos}} \ce{1d}\ \ce{1h}\ \ce{3f}\ \ce{3g}\ \ce{6g}\ \ev1\ \ra1\ \ra3\ \ra6\ (est: 2019\==10\==21)
    \begin{longenum}
        \item Tipos básicos
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Metodología de la programación}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{3f}\ \ce{3g}\ \ev1\ \ra1\ \ra3\ \ra6\ (est: 2019\==10\==28)
    \begin{longenum}
        \item Ciclo de vida
    ...
    \end{longenum}
    \item \textbf{\textsc{Entrada y salida de información}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{3f}\ \ce{3g}\ \ce{5a}\ \ce{5b}\ \ce{5c}\ \ce{5d}\ \ce{5e}\ \ce{6h}\ \ce{6i}\ \ev1\ \ra1\ \ra3\ \ra5\ \ra6\ (est: 2019\==11\==11)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Calidad I}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{3f}\ \ce{3g}\ \ev1\ \ra1\ \ra3\ (est: 2019\==11\==18)
    \begin{longenum}
        \item Depuración
        \begin{longenum}
            \item \texttt{print()}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Complejidad algorítmica}} \ev1\ \opcional\ (est: 2019\==11\==25)
    \begin{longenum}
        \item Introducción
