\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Manipulación de tipos}} \ev1\ (est: 2019\==10\==28)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Metodología de la programación}} \ev1\ (est: 2019\==11\==04)
    \begin{longenum}
        \item Ciclo de vida
    ...
    \end{longenum}
    \item \textbf{\textsc{Complejidad algorítmica}} \ev1\ (est: 2019\==11\==18)
    \begin{longenum}
        \item Introducción
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Entrada y salida de información}} \ev1\ (est: 2019\==11\==25)
    \begin{longenum}
        \item Flujos
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Calidad I}} \ev1\ (est: 2019\==12\==02)
    \begin{longenum}
        \item Depuración
        \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Calidad II}} \ev3\ (est: 2020\==04\==20)
    \begin{longenum}
