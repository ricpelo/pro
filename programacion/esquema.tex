\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Abstracción de datos}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{3f}\ \ce{3g}\ \ev2\ \ra1\ \ra3\ \ra6\ (est: 2019\==11\==11)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
            \item Introducción
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Elementos básicos del lenguaje Java}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{1d}\ \ce{1e}\ \ce{1f}\ \ce{1h}\ \ce{1i}\ \ce{2b}\ \ce{2i}\ \ce{3a}\ \ce{3b}\ \ce{3c}\ \ce{3e}\ \ce{3f}\ \ce{3g}\ \ra1\ \ra2\ \ra3\ \ra5\ (est: 2020\==01\==29)
    \begin{longenum}
