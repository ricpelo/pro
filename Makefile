...
EJER_SOURCES := $(shell find $(EJER_SRCDIR) -type f,l -name "*.md")
...
touch:
	touch $(OBJECTS_HTML) $(OBJECTS_PDF) $(APUNTES_PDF) $(PROG_PDF) $(DIAPOS) $(EJER_OBJECTS_PDF) $(PROG_PDF)
