\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación orientada a objetos}} \ce{3h}\ \ce{4a}\ \ce{4b}\ \ce{4c}\ \ce{4d}\ \ce{4e}\ \ce{4f}\ \ce{4g}\ \ce{4i}\ \ce{6g}\ \ev2\ \ra3\ \ra4\ \ra6\ (est: 2026\==02\==18)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
            \item Recapitulación
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Relaciones entre clases}} \ce{4a}\ \ce{4b}\ \ce{4c}\ \ce{4d}\ \ce{4e}\ \ce{4f}\ \ce{4g}\ \ce{4h}\ \ce{4i}\ \ce{7a}\ \ce{7b}\ \ce{7c}\ \ce{7d}\ \ce{7e}\ \ce{7f}\ \ce{7g}\ \ce{7h}\ \ce{7i}\ \ce{7j}\ \ev2\ \ra4\ \ra7\ (est: 2026\==02\==25)
    \begin{longenum}
