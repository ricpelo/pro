\begin{longenum}
    \item \textbf{\textsc{Introducción}} \ev1\ \ra1\ \ra3\ \ce{1g}\ \ra2\ \ce{2h}\ \ce{1a}\ (Est: 2019-09-16)
    \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Complejidad algorítmica}} \ev1\ (Est: 2019-11-04)
    \begin{longenum}
        \item Introducción
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación modular I}} \ev1\ (Est: 2019-11-11)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Calidad}} \ev1\ (Est: 2019-11-25)
    \begin{longenum}
        \item Pruebas
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Estructuras de datos lineales}} \ev2\ (Est: 2020-01-08)
    \begin{longenum}
        \item Acceso directo
        \begin{longenum}
            \item Vectores
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Ordenación y búsqueda}} \ev2\ (Est: 2020-01-15)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Estructuras de datos no lineales}} \ev2\ (Est: 2020-01-22)
    \begin{longenum}
        \item Árboles
        \begin{longenum}
            \item Binarios
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Abstracción de datos}} \ev2\ (Est: 2020-01-29)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación orientada a objetos}} \ev2\ (Est: 2020-02-05)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Diseño de clases}} \ev2\ (Est: 2020-02-12)
    \begin{longenum}
        \item Encapsulación
        \item Propiedades
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Composición, herencia y poliformismo}} \ev2\ (Est: 2020-02-19)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Programación modular II}} \ev2\ (Est: 2020-02-26)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Mecanismos de control de errores}} \ev2\ (Est: 2020-03-04)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Interoperabilidad}} \ev2\ (Est: 2020-03-11)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Buenas prácticas en programación orientada a objetos}} \ev2\ (Est: 2020-03-18)
    \begin{longenum}
        \item Declaraciones de tipos
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Gestión de bases de datos relacionales}} \ev2\ (Est: 2020-03-25)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Introducción al lenguaje de programación Java}} \ev3\ (Est: 2020-04-13)
    \begin{longenum}
        \item Introducción
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Librerías estándar de Java}} \ev3\ (Est: 2020-04-20)
    \begin{longenum}
        \item Paquetes
