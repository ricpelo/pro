\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Expresiones}} \ce{1c}\ \ce{1f}\ \ce{1g}\ \ce{2f}\ \ev1\ \ra1\ \ra2\ (est: 2022\==09\==26)
    \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación funcional (II)}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{1e}\ \ce{2g}\ \ce{3f}\ \ce{3g}\ \ev1\ \ra1\ \ra2\ \ra3\ (est: 2022\==10\==17)
    \begin{longenum}
        \item Computabilidad
        \begin{longenum}
