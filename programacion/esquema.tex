\begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Interfaces gráficas de usuario}} \ce{5f}\ \ce{5g}\ \ce{5h}\ \ev2\ \ra5\ (est: 2026\==03\==04)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Bases de datos orientadas a objetos}} \ce{8a}\ \ce{8b}\ \ce{8c}\ \ce{8d}\ \ce{8e}\ \ce{8f}\ \ce{8g}\ \ce{8h}\ \ev2\ \ra8\ (est: 2026\==03\==11)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Bases de datos relacionales}} \ce{9a}\ \ce{9b}\ \ce{9c}\ \ce{9d}\ \ce{9e}\ \ce{9f}\ \ce{9g}\ \dual\ \ev3\ \ra9\ (est: 2026\==04\==06)
    \begin{longenum}
