\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Expresiones}} \ce{1d}\ \ce{1f}\ \ce{1g}\ \ce{2f}\ \ce{2g}\ \ev1\ \ra1\ \ra2\ (est: 2024\==09\==23)
    \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación estructurada}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{2h}\ \ce{2i}\ \ce{3a}\ \ce{3b}\ \ce{3c}\ \ce{3d}\ \ce{3f}\ \ce{3g}\ \ce{3i}\ \ev1\ \ra1\ \ra2\ \ra3\ \ra4\ (est: 2024\==10\==28)
    \begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Relaciones entre clases}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{2e}\ \ce{3f}\ \ce{3g}\ \ce{4a}\ \ce{4b}\ \ce{4c}\ \ce{4d}\ \ce{4e}\ \ce{4f}\ \ce{4g}\ \ce{4h}\ \ce{4i}\ \ce{7a}\ \ce{7b}\ \ce{7c}\ \ce{7d}\ \ce{7e}\ \ce{7f}\ \ce{7g}\ \ce{7i}\ \ce{7j}\ \ev2\ \ra1\ \ra3\ \ra4\ \ra7\ (est: 2025\==01\==15)
    \begin{longenum}
