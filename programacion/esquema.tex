\begin{longenum}
    ...
    \end{longenum}
    \item \textbf{Tipos de datos} \ev1 (Est: 2019-11-11)
    \begin{longenum}
        \item Introducción
        \item Tipos básicos
        \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{Metodología de la programación} \ev1 (Est: 2019-10-21)
    \begin{longenum}
        \item Ciclo de vida
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{Complejidad algorítmica} \ev1 (Est: 2019-10-28)
    \begin{longenum}
        \item Introducción
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{Programación modular I} \ev1 (Est: 2019-11-04)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
