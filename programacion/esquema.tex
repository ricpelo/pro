\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación orientada a objetos}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{2a}\ \ce{2b}\ \ce{2c}\ \ce{2d}\ \ce{2e}\ \ce{2f}\ \ce{2h}\ \ce{2i}\ \ce{3f}\ \ce{3g}\ \ce{4a}\ \ce{4b}\ \ce{4c}\ \ce{4d}\ \ce{4e}\ \ce{4f}\ \ce{4h}\ \ev2\ \ra1\ \ra2\ \ra3\ \ra4\ (est: 2024\==01\==08)
    \begin{longenum}
        \item Introducción
        \begin{longenum}
            \item Recapitulación
