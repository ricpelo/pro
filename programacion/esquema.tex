\begin{longenum}
    ...
    \begin{longenum}
        ...
        \item Serialización de \textit{arrays}
        \begin{longenum}
            \item \texttt{serialize()}
            \item \texttt{unserialize()}
        \end{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Calidad I}} \ev1\ (est: 2019\==11\==25)
    \begin{longenum}
        \item Depuración
        \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Programación genérica}} \ev2\ (est: 2020\==02\==26)
    \begin{longenum}
        ...
        \item Limitaciones
    \end{longenum}
    \item \textbf{\textsc{Estructuras de datos lineales}} \ev2\ (est: 2020\==03\==04)
    \begin{longenum}
        \item Acceso directo
        \begin{longenum}
            \item \textit{Arrays}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Ordenación y búsqueda}} \ev2\ (est: 2020\==03\==11)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Estructuras de datos no lineales}} \ev2\ (est: 2020\==03\==18)
    \begin{longenum}
        \item Árboles
        \begin{longenum}
            \item Binarios
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Control de excepciones}} \ev2\ (est: 2020\==03\==25)
    \begin{longenum}
    ...
    \end{longenum}
    \item \textbf{\textsc{Java Collections Framework}} \ev3\ (est: 2020\==04\==13)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Principios y patrones de diseño}} \ev3\ (est: 2020\==04\==20)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Calidad II}} \ev3\ (est: 2020\==04\==27)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Gestión de bases de datos relacionales}} \ev3\ (est: 2020\==05\==04)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Programación de interfaces gráficas de usuario}} \ev3\ \opcional\ (est: 2020\==05\==11)
    \begin{longenum}
        \item JFC y Swing
