\begin{longenum}
    ...
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Estructuras de datos lineales}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{3f}\ \ce{3g}\ \ce{6a}\ \ce{6c}\ \ce{6d}\ \ce{6e}\ \ev3\ \opcional\ \ra1\ \ra3\ \ra6\ (est: 2025\==04\==30)
    \begin{longenum}
        ...
        \end{longenum}
    \end{longenum}
    \item \textbf{\textsc{Ordenación y búsqueda}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{3f}\ \ce{3g}\ \ce{6c}\ \ce{6d}\ \ce{6e}\ \ev3\ \opcional\ \ra1\ \ra3\ \ra6\ (est: 2025\==05\==07)
    \begin{longenum}
        ...
        \item Tablas \textit{Hash}
    \end{longenum}
    \item \textbf{\textsc{Estructuras de datos no lineales}} \ce{1a}\ \ce{1b}\ \ce{1c}\ \ce{3f}\ \ce{3g}\ \ce{6c}\ \ce{6d}\ \ce{6e}\ \ev3\ \opcional\ \ra1\ \ra3\ \ra6\ (est: 2025\==05\==14)
    \begin{longenum}
        \item Árboles
        \begin{longenum}
            \item Binarios
