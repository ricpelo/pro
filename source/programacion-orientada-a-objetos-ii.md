...
- ¿No se podría haber hecho con un simple método estático?

- La ventaja de los métodos estáticos es que respeta la herencia.

- Es decir, que una subclase de Racional podría llamar a `desde_tupla` y
  recibiría la instancia correcta.

- Por eso, los constructores alternativos en Python son métodos de clase por
  convenio.

- El concepto de herencia y subclase lo veremos posteriormente.
